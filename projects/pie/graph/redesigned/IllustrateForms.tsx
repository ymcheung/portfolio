...
export default function IllustrateForms({ confirms, empty, indicateConfirm }: IllustrateProps) {
  return(
    <Icon viewBox="0 0 108 192" xmlns="http://www.w3.org/2000/svg">
      ...
      <Indicator display={indicateConfirm} animation={{ '@mReduced': 'reduced' }} cx="90" cy="32" r="4"/>
    </Icon>
  );
}
